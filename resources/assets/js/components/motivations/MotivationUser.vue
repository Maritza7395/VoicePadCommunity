                  ...
                  <b-col md="9">
                    <form  v-on:submit.prevent="createMotivation"  class="form-horizontal" >
                      <div class="row">
                          ...
                          <div class="col-sm-offset-2 col-m-2" style="margin-top: -6px;">
                            <button type="submit" style="height: 35px; margin-left: 5px;" class="btn bg-blue fs-it-btn"><i class="fa fa-plus" aria-hidden="true"></i>
                            <span class="fs-it-btn-vertical-line"></span>Añadir</button>
                            
                            <b-btn @click='printFunc()' variant="outline-secondary" style="margin-top: -4px;" v-b-tooltip.hover title="Imprimir"><img src="https://img.icons8.com/color/48/000000/print.png" width="25"></b-btn>
                          </div>
                      </div>
                    </form>
                  </b-col>
...
export default {
    ...
    methods:{
      ...
      printFunc() {     
        ...
        var htmlToPrint = "<tr>"+
                            "<td><p style='text-align:center;'>Motivos de Denuncias a Usuarios</p></td>"+
        ...
        deleteOk(evt){
            axios.delete('/motivos-usuario/'+this.idMotivationDelete).then(response=>{
                console.log(response);
                this.getMotivations();
            }).catch(error=>{
                console.log(error);
        ...
        editMotivation: function(){
            axios.put('/motivos-usuario/'+this.idMotivationEdit,{
                name: this.nameEdit,
